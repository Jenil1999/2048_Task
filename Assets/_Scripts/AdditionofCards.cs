...
public class AdditionofCards : MonoBehaviour
{
    ...
    {
        // BlockManager.Instance.AllBlockManager[_index];

   //     _index = CardMovement.Instance.indexNumber;
                     ...
                     { 
                        BlockManager.Instance.AllBlockManager[_index][_lastIndex].transform.DOScale(new Vector3(1, 1, 1), .15f).OnComplete(() =>
                        {
                            ...
                            if (BlockManager.Instance.AllBlockManager[_index].Count > 0)
                            {
                                            ...
                                            //Debug.Log("Card in B1 List is more then 1");
                                            //Debug.Log("Crct Position " + CardMovement.Instance._correctPos);
                            ...
                            else
                            {
                                ...
                                UiManager.instance.scoreCard.text = _score.ToString();
